...
namespace Interfaces
{
    ...
    internal class Camiones : TransporteDeCarga
    {
        public Camiones()
        {
            techo = true;
        ...
        public string getCamiones()
        {
            return "El vehiculo tiene la siguiente informacion: \n Si tiene techo: :"
              ...
              "\nEl numero de ventanas: \n" + ventanas + "Si tiene parachoques: " + parachoques + "El cilindraje: "
              + clindraje + "Si tiene remolque de carga" + remolqueCarga + "El deposito de aceite: " + DepositoAceite;
